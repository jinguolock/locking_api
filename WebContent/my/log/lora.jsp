...
<%@page import="com.islora.lock.wx.server.db.dao.LcLogLoraDao"%>
...
<%@page import="com.islora.lock.wx.server.db.entity.LcLogLora"%>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><%=user.getUsername() %>的LORA日志</h3>
              <div class="box-tools">
              <div class="btn-group">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                <%
                List<LcLogLora> logs=new LcLogLoraDao().findByOwnerId(user.getId()); 
                ...
                <tr>
                  ...
                  <td><%=log.getUptime()%></td>
                  <td><%=log.getGatewaySn() %></td>
                  <td><%=log.getSystemSn() %></td>
                  <td><%=log.getRssi() %></td>
                  <td><%=log.getSnr() %></td>
                </tr>
                <%	}
