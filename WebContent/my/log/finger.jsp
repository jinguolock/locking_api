...
<%@page import="com.islora.lock.wx.server.db.dao.LcLogFingerDao"%>
...
<%@page import="com.islora.lock.wx.server.db.entity.LcLogFinger"%>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                <%
                List<LcLogFinger> logs=new LcLogFingerDao().findByOwnerId(user.getId()); 
