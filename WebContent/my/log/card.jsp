...
<%@page import="com.islora.lock.wx.server.db.dao.LcLogCardDao"%>
...
<%@page import="com.islora.lock.wx.server.db.entity.LcLogCard"%>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><%=user.getUsername() %>的刷卡开锁日志</h3>
              <div class="box-tools">
              <div class="btn-group">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                <%
                List<LcLogCard> logs=new LcLogCardDao().findByOwnerId(user.getId()); 
                ...
                if(logs!=null&&logs.size()>0){
                	for(LcLogCard log:logs){
                		String tt=MyProp.getCardLogResult(log.getCardResult());
