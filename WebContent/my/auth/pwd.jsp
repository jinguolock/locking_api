...
<%@page import="com.islora.lock.wx.server.db.dao.LcAuthPwdDao"%>
...
<%@page import="com.islora.lock.wx.server.db.entity.LcAuthPwd"%>
...
<head>
  ...
  function authDelete(authId){
	  $.get("<%=path %>/auth",{c:"deletepwd",pwdId:authId}, function(result){
			alert("已删除！");
			location.reload();
		  },"json");
  }
  ...
  function footer(){
	  ...
	  $.get("<%=path %>/auth",{c:"getallpwd"}, function(result){
		  allAuth=result;
		  for(var i=0;i<allAuth.length;i++){
				var com=allAuth[i];
				com.name=decodeURI(com.name);
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools">
              <div class="btn-group">
                  <button type="button"   data-toggle="modal" data-target="#modal-add-auth" class="btn btn-block btn-info">添加密码</button>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                <%
                List<LcAuthPwd> auths=new LcAuthPwdDao().findByOwnerId(user.getId()); 
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
            	...
            	<tr>
                	<td>输入密码：</td>
                	<td><input type="text" id="add_auth_pwd" name="pwd" class="form-control" placeholder="输入密码"></td>
                </tr>
                <tr>
                	<td>输入描述：</td>
                	<td><input type="text" id="add_auth_name" name="pwd" class="form-control" placeholder="输入描述"></td>
                </tr>
                <tr>
                	<td>开门次数：</td>
                ...
                <tr>
                  ...
                  <select id="add_auth_type" class="form-control">
                  	<option value="server">普通密码</option>
                    <option value="hw">固件密码</option>
                    <option value="template">临时密码</option>
                  </select>
                </div></td>
                </tr>
              ...
              <div class="modal-footer">
                ...
                <button type="button" onclick="authAdd()" class="btn btn-primary" data-dismiss="modal">添加密码</button>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">修改授权密码</h4>
              </div>
              <div class="modal-body">
                <table  style="border-collapse:separate; border-spacing:0px 10px;width:500px">
                <tr>
                	<td>密码：</td>
                	<td><input type="text" id="edit_auth_pwd" name="pwd" class="form-control" placeholder="输入密码"></td>
                </tr>
                <tr>
                	<td>描述：</td>
